...
const ImageGallery = () => {
    ...
    const images = [
        { url: '/images/aeroport.jpeg', alt: 'Retour des membres internationaux' },
        { url: '/images/manger.jpeg', alt: 'Réunions' },
        { url: '/images/photo2.jpeg', alt: 'Réunions' },
        { url: '/images/priere.jpeg', alt: 'Moments de prière' },
        { url: '/images/priere2.jpeg', alt: 'Moments de prière' }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1/4 h-3/4 opacity-40 transition-all duration-500 z-10">
                        <img
                            src={images[visible.prev].url}
                            alt={images[visible.prev].alt}
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-1/2 h-full transition-all duration-500 z-20">
                        <img
                            src={images[visible.current].url}
                            alt={images[visible.current].alt}
                    ...
                    <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1/4 h-3/4 opacity-40 transition-all duration-500 z-10">
                        <img
                            src={images[visible.next].url}
                            alt={images[visible.next].alt}
                            className="w-full h-full object-cover rounded-lg shadow-lg"
                        />
                    </div>

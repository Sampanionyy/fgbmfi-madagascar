...
const Navbar = () => {
    ...
    const navItems = [
        { label: 'À PROPOS DE NOUS', hasDropdown: true },
                                ...
                                <div key={idx} className="relative group">
                                    ...
                                    {item.hasDropdown && (
                                        <div className="absolute top-full left-0 mt-2 w-48 bg-white shadow-xl rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 py-2">
                                            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-primary hover:text-white transition-colors">Option 1</a>
                                            <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-primary hover:text-white transition-colors">Option 2</a>
                                        </div>
                                    )}
                                </div>
                            ))}
